...
<?php
		...
		$update = mysqli_query($koneksi, "UPDATE srv1 SET MAI4= 'Summarization' WHERE username='$username'") or die(mysqli_error());
			...
			if($update){
                            ...
                            echo "<script>alert('Data Berhasil di Simpan!'); window.location = 'materisumm.php'</script>";
