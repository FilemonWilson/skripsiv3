...
<body onload="countDown();">
    ...
    <div class="col-sm-2">
		...
		<div class="col-sm-8" align="center">
			<h2>Summarization</h2>
			<hr>
        <form name="formsumm" id="formsumm" action="proses_simpansumm.php" method="POST">
          <textarea id="summernote" name="summ" ></textarea>
          
            <br>
            <button type="submit" name="input" id="input" class="btn btn-sm btn-primary">Simpan</button>
                    <a href="materisumm.php" class="btn btn-sm btn-danger">Kembali</a>
            </div>
        </form>
    </div>
    <!--/Center Column-->
